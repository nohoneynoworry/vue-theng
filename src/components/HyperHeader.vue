      ...
      <div class="flex flex-1 items-center justify-end md:justify-between">
        <nav aria-label="Global" class="hidden md:block">
          <ul class="flex items-center gap-6 text-sm">
            ...
            <li>
              <router-link class="text-gray-500 transition hover:text-gray-500/75" to="/list-files"> {{ $t('fileView')
              }}
              </router-link>
            </li>
            <li>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="sm:flex sm:gap-4">
            <button type="button" class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700 "
              aria-haspopup="dialog" aria-expanded="false" aria-controls="login-modal" data-hs-overlay="#login-modal">
              Login
            </button>

            <button type="button"
              class="hover:cursor-pointer hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 transition hover:text-teal-600/75 sm:block"
