<template>
  <div class="max-w-6xl mx-auto mt-10 p-6 bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-2xl shadow-lg">
    ...
    <div v-else class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
      <div v-for="user in users" :key="user.id"
        ...
        <div class="space-y-1 text-sm text-gray-700">
          ...
          <p><span class="font-medium text-purple-700">Salary:</span> {{ formatSalary(user.salary) }} </p>
        </div>
      </div>
    </div>
  </div>
