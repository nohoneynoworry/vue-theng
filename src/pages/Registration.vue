<template>
  <div class="max-w-sm mx-auto mt-10 p-6 bg-green-500 rounded-2xl shadow-md">
      ...
      validationSchema: yup.object(
        {
          ...
          age: yup.number().min(10, 'Minimum age of 10').max(100, 'Maximum age of 100').required('Age is required')
        })
    }
  },
  methods: {
